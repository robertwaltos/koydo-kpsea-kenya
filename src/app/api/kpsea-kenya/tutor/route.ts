...
const EXAM_ID = "kpsea-kenya";
const EXAM_DISPLAY_NAME = "KPSEA (Kenya Primary School Education Assessment)";

const TUTOR_SYSTEM_PROMPT = `You are an expert AI tutor for ${EXAM_DISPLAY_NAME}. Respond in English.

Cover all KPSEA subjects: Literacy & Communication, Kiswahili Communication, Mathematical Activities, Environmental Activities, Creative Activities, and Religious Activities. Align to KNEC KPSEA framework.
