...
export const metadata: Metadata = {
  title: "Pricing — Kpsea Kenya Premium",
  description: "Unlock unlimited Kpsea Kenya practice with Koydo Premium.",
};

export default function PricingPage() {
  const checkoutUrl = `https://koydo.app/pricing?exam=kpsea-kenya&cadence=annual`;
