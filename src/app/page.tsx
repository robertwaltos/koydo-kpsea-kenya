...
export const metadata: Metadata = {
  title: "Koydo KPSEA Kenya — Free Exam Prep",
  description: "Comprehensive KPSEA Kenya preparation. Practice tests, AI tutor, score tracking. Study aid only. Not affiliated with official examination boards.",
};
    ...
    <main className="min-h-screen">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-[var(--accent)] to-[var(--accent-dark)] px-4 py-20 text-white">
        <div className="mx-auto max-w-4xl text-center">
          <span className="mb-4 inline-block rounded-full bg-white/20 px-4 py-1.5 text-sm font-medium backdrop-blur">
            Tier 6 · large annual test takers
          </span>
          <h1 className="mb-6 text-4xl font-extrabold tracking-tight sm:text-5xl md:text-6xl">
            Ace KPSEA Kenya with Koydo
          </h1>
      ...
      <section className="mx-auto max-w-5xl px-4 py-16">
        <h2 className="mb-10 text-center text-2xl font-bold text-zinc-900 dark:text-zinc-100">
          Why Koydo for KPSEA Kenya?
        </h2>
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {[
            { icon: "📝", title: "Practice Tests", desc: "Hundreds of practice questions matching the real KPSEA Kenya format." },
